...
const Products = () => {
    const { products, fetchProducts, addToCart, currentPage, perPages } = useStore();
                ...
                {currentProducts && currentProducts.map((product) => (
                    ...
                    <li className={`
                        ...
                        <div className="flex items-center justify-around w-full pt-4">
                            ...
                            <button className='hover:text-white hover:bg-indigo-400 transition-all bg-indigo-900/20 rounded-xl p-1 w-1/4 z-30' onClick={() => product.stock !== undefined && product.stock > 0 && addToCart(product, 1)}><AddShoppingCartIcon sx={{ fontSize: 20 }} /></button>
                        </div>
                    </li>
